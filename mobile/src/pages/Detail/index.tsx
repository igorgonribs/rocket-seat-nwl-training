...
const Detail = () => {
    ...
    function handleWhatsapp() {
        Linking.openURL(`whatsapp://send?phone=${data.whatsapp}$text=Olá, Tenho interesse na coleta de resíduos`)
    }
        ...
        <SafeAreaView style={{ flex: 1 }}>
            <View style={styles.container}>
                <TouchableOpacity onPress={handleNavigateBack}>
                    <Icon as Icon name='arrow-left' size={20} color='#34cb79'></Icon>
                </TouchableOpacity>
